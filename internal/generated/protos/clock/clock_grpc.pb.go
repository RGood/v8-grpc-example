...
type ClockClient interface {
	Now(ctx context.Context, in *TimeRequest, opts ...grpc.CallOption) (*TimeResponse, error)
}
...
func (c *clockClient) Now(ctx context.Context, in *TimeRequest, opts ...grpc.CallOption) (*TimeResponse, error) {
...
type ClockServer interface {
	Now(context.Context, *TimeRequest) (*TimeResponse, error)
...
func (UnimplementedClockServer) Now(context.Context, *TimeRequest) (*TimeResponse, error) {
...
func _Clock_Now_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClockServer).Now(ctx, req.(*TimeRequest))
	}
...
var Clock_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "protos/clock/clock.proto",
}
